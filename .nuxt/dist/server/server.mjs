import { reactive, hasInjectionContext, getCurrentInstance, version, unref, ref, watchEffect, watch, inject, toRef, nextTick, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, h, defineComponent, computed, Suspense, mergeProps, Transition, provide, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-6d3057fb.js").then((m) => m.default || m)
  },
  {
    name: "movies-id",
    path: "/movies/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-a76ffc02.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-fbbd868e.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-de159be9.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-6797521b.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-bdb201ea.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
